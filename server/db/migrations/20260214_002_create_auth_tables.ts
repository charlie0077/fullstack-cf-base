...
export async function up(knex: Knex): Promise<void> {
  // User table (better-auth default name)
  ...
  // Session table (better-auth default name)
  ...
  // Account table (better-auth default name)
  ...
  // Verification table (better-auth default name)
